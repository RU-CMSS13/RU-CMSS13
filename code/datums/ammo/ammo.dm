...
/datum/ammo/proc/fire_bonus_projectiles(obj/projectile/original_P, gun_damage_mult = 1, projectile_max_range_add = 0, bonus_proj_scatter = 0) //gun_damage_mult = 1, projectile_max_range_add = 0, bonus_proj_scatter = 0)
	set waitfor = 0

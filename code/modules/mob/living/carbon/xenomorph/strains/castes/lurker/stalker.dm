/datum/xeno_strain/stalker
	name = "Сталкер"
	description = "Мутация - Сталкер: Вы обмениваете свою способность замедляющего удара на возможность становится невидимым в режиме ходьбы на неопределённый срок."

...
*/
	paygrades = list(PAY_SHORT_ME4 = JOB_PLAYTIME_TIER_0, PAY_SHORT_ME5 = JOB_PLAYTIME_TIER_1, PAY_SHORT_ME6 = JOB_PLAYTIME_TIER_2, PAY_SHORT_ME7 = 50 HOURS, PAY_SHORT_ME8 = JOB_PLAYTIME_TIER_3, PAY_SHORT_ME8E = 100 HOURS)
	role_comm_title = "MP"

...
*/
	paygrades = list(PAY_SHORT_WYC2 = JOB_PLAYTIME_TIER_0, PAY_SHORT_WYC3 = JOB_PLAYTIME_TIER_1, PAY_SHORT_WYC4 = JOB_PLAYTIME_TIER_2, PAY_SHORT_WYC5 = JOB_PLAYTIME_TIER_3, PAY_SHORT_WYC6 = JOB_PLAYTIME_TIER_4, PAY_SHORT_WYC7 = JOB_PLAYTIME_TIER_5)
	role_comm_title = "CL"

...
/datum/equipment_preset/uscm_ship/corp_sec
	...
	paygrades = list(PAY_SHORT_WY_SEC_PPO = JOB_PLAYTIME_TIER_0, PAY_SHORT_WY_SEC = JOB_PLAYTIME_TIER_1, PAY_SHORT_WY_SEC_PPS = JOB_PLAYTIME_TIER_2, PAY_SHORT_WY_SEC_LEAD = JOB_PLAYTIME_TIER_3, PAY_SHORT_WY_SEC_PPC = JOB_PLAYTIME_TIER_4)
	role_comm_title = "CS"

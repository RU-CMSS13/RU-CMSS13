...
/obj/item/clothing/glasses/disco_fever/Initialize(mapload, ...)
	...
	obj_glass_overlay.vis_flags = VIS_INHERIT_ICON|VIS_INHERIT_LAYER|VIS_INHERIT_PLANE|VIS_INHERIT_ID
	...
	mob_glass_overlay.vis_flags = VIS_INHERIT_DIR|VIS_INHERIT_LAYER|VIS_INHERIT_PLANE|VIS_INHERIT_ID

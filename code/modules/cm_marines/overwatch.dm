...
*/
//RUCM START
/obj/structure/machinery/computer/overwatch/proc/transfer_talk(obj/item/camera, mob/living/sourcemob, message, verb = "says", datum/language/language, italics = FALSE, tts_heard_list, show_message_above_tv = FALSE)
//RUCM END
	SIGNAL_HANDLER
	if(inoperable())
		return

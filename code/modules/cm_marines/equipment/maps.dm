GLOBAL_LIST_INIT(mapless_maps, list(MAP_RUNTIME, MAP_CHINOOK, MAIN_SHIP_DEFAULT_NAME, MAIN_RU_SHIP_DEFAULT_NAME, MAP_ROSTOCK, MAP_HUNTERSHIP))
...
/proc/setup_all_maps()
	return list(
		...
		//RUCM CODE START
		MAP_LV624_LAZARUS_LANDING = new /obj/item/map/lazarus_landing_map(),
		//RUCM CODE END

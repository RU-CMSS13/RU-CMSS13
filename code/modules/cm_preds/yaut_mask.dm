...
/obj/item/clothing/mask/gas/yautja
	...
	var/list/mask_actions = list(/datum/action/predator_action/mask/zoom, /datum/action/predator_action/mask/visorб /datum/action/item_action/specialist/yautja_aimed_shot)

...
/obj/structure/machinery/vending/walkman
	...
	products = list(
		...
		/obj/item/device/cassette_tape/hotline = 10,
		/obj/item/device/cassette_tape/puma = 10,
		/obj/item/device/cassette_tape/duck = 10,
	...
	prices = list(
		...
		/obj/item/device/cassette_tape/hotline = 5,

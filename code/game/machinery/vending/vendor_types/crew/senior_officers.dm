...
GLOBAL_LIST_INIT(cm_vending_clothing_cmo, list(
		...
		list("Officer M3 Hivelord Armor", 0, /obj/item/clothing/suit/storage/marine/MP/SO/xeno/hivelord, MARINE_CAN_BUY_COMBAT_ARMOR, VENDOR_ITEM_MANDATORY),
		list("Officer M10 Hivelord Helmet", 0, /obj/item/clothing/head/helmet/marine/MP/SO/xeno/hivelord, MARINE_CAN_BUY_COMBAT_HELMET, VENDOR_ITEM_MANDATORY),

...
/* RUCM EDIT START (На танке уже есть башня, зачем ему вторая?)
...
*///RUCM EDIT END
	...
	list("Ballistic", 0, /obj/item/hardpoint/armor/ballistic, VEHICLE_ARMOR_AVAILABLE, VENDOR_ITEM_REGULAR),//RUCM EDIT END

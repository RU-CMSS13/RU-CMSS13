...
GLOBAL_LIST_INIT(cm_vending_clothing_intelligence_officer, list(
		...
		list("USCM Poncho (Mission-Specific Camo)", 0, /obj/item/clothing/accessory/poncho, MARINE_CAN_BUY_ACCESSORY, VENDOR_ITEM_REGULAR),
		list("USCM Poncho (Green)", 0, /obj/item/clothing/accessory/poncho/green, MARINE_CAN_BUY_ACCESSORY, VENDOR_ITEM_REGULAR),
		list("USCM Poncho (Brown)", 0, /obj/item/clothing/accessory/poncho/brown, MARINE_CAN_BUY_ACCESSORY, VENDOR_ITEM_REGULAR),
		list("USCM Poncho (Black)", 0, /obj/item/clothing/accessory/poncho/black, MARINE_CAN_BUY_ACCESSORY, VENDOR_ITEM_REGULAR),
		list("USCM Poncho (Blue)", 0, /obj/item/clothing/accessory/poncho/blue, MARINE_CAN_BUY_ACCESSORY, VENDOR_ITEM_REGULAR),
		list("USCM Poncho (Purple)", 0, /obj/item/clothing/accessory/poncho/purple, MARINE_CAN_BUY_ACCESSORY, VENDOR_ITEM_REGULAR),

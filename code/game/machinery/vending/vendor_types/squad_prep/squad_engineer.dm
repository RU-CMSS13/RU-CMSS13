...
GLOBAL_LIST_INIT(cm_vending_gear_engi, list(
		...
		list("Entrenching Tool (ET)", 1, /obj/item/tool/shovel/etool, null, VENDOR_ITEM_REGULAR),
		...
		list("Breaching Charge", 4, /obj/item/explosive/plastic/breaching_charge, null, VENDOR_ITEM_RECOMMENDED),
		...
		list("Welding Goggles", 2, /obj/item/clothing/glasses/welding, null, VENDOR_ITEM_REGULAR),
		...
		list("M20 Mine Box (x4 mines)", 12, /obj/item/storage/box/explosive_mines, null, VENDOR_ITEM_REGULAR),
		...
		list("M4 Pattern Armor", 24, /obj/item/clothing/suit/storage/marine/rto, null, VENDOR_ITEM_REGULAR),
		...
		list("Machete Pouch (Full)", 6, /obj/item/storage/pouch/machete/full, null, VENDOR_ITEM_REGULAR),

...
GLOBAL_LIST_INIT(cm_vending_gear_tl, list(
		...
		list("M74 AGM-Smoke Airburst Packet (x3 airburst grenades)", 5, /obj/item/storage/box/packet/airburst_smoke, null, VENDOR_ITEM_REGULAR),
		...
		list("M79 Grenade Launcher", 25, /obj/item/storage/box/guncase/m79, null, VENDOR_ITEM_REGULAR),

...
GLOBAL_LIST_INIT(cm_vending_gear_medic, list(
		...
		list("Fire Firstaid Kit", 5, /obj/item/storage/firstaid/fire, null, VENDOR_ITEM_REGULAR),
		list("Toxin Firstaid Kit", 5, /obj/item/storage/firstaid/toxin, null, VENDOR_ITEM_REGULAR),
		list("Oxygen Firstaid Kit", 5, /obj/item/storage/firstaid/o2, null, VENDOR_ITEM_REGULAR),
		list("Radiation Firstaid Kit", 5, /obj/item/storage/firstaid/rad, null, VENDOR_ITEM_REGULAR),
		...
		list("Pill Bottle (Bicaridine)", 3, /obj/item/storage/pill_bottle/bicaridine, null, VENDOR_ITEM_RECOMMENDED),
		list("Pill Bottle (Dexalin)", 3, /obj/item/storage/pill_bottle/dexalin, null, VENDOR_ITEM_REGULAR),
		list("Pill Bottle (Dylovene)", 3, /obj/item/storage/pill_bottle/antitox, null, VENDOR_ITEM_REGULAR),
		list("Pill Bottle (Inaprovaline)", 3, /obj/item/storage/pill_bottle/inaprovaline, null, VENDOR_ITEM_REGULAR),
		list("Pill Bottle (Kelotane)", 3, /obj/item/storage/pill_bottle/kelotane, null, VENDOR_ITEM_RECOMMENDED),
		list("Pill Bottle (Peridaxon)", 3, /obj/item/storage/pill_bottle/peridaxon, null, VENDOR_ITEM_REGULAR),
		list("Pill Bottle (Tramadol)", 3, /obj/item/storage/pill_bottle/tramadol, null, VENDOR_ITEM_RECOMMENDED),
		...
		list("Stasis Bag", 5, /obj/item/bodybag/cryobag, null, VENDOR_ITEM_REGULAR),
		...
		list("M3 B12 Pattern Armor", 25, /obj/item/clothing/suit/storage/marine/leader, null, VENDOR_ITEM_REGULAR),
		list("M4 Pattern Armor", 25, /obj/item/clothing/suit/storage/marine/rto, null, VENDOR_ITEM_REGULAR),
		list("Range Finder", 8, /obj/item/device/binoculars/range, null, VENDOR_ITEM_REGULAR),
		list("Laser Designator", 10, /obj/item/device/binoculars/range/designator, null, VENDOR_ITEM_REGULAR),

...
GLOBAL_LIST_INIT(cm_vending_gear_spec, list(
		...
		list("A19 High Velocity Magazine (10x24mm)", 10, /obj/item/ammo_magazine/rifle/m4ra/custom, null, VENDOR_ITEM_REGULAR),
		...
		list("M42A Marksman Magazine (10x28mm Caseless)", 10, /obj/item/ammo_magazine/sniper, null, VENDOR_ITEM_REGULAR),
		...
		list("M74 AGM-S Smoke Grenades x6", 5, /obj/effect/essentials_set/agms_6_pack, null, VENDOR_ITEM_REGULAR),

		list("EXTRA FLAMETHROWER TANKS", 0, null, null, null),
		list("Large Incinerator Tank", 10, /obj/item/ammo_magazine/flamer_tank/large, null, VENDOR_ITEM_REGULAR),
		...
		list("Autoinjector Pouch (Full)", 10, /obj/item/storage/pouch/autoinjector/full/skillless, null, VENDOR_ITEM_REGULAR),
		...
		list("Powerloader Certification", 25, /obj/item/pamphlet/skill/powerloader, null, VENDOR_ITEM_REGULAR),

		list("RADIO KEYS", 0, null, null, null),
		list("Engineering Radio Encryption Key", 4, /obj/item/device/encryptionkey/engi, null, VENDOR_ITEM_REGULAR),
		list("Intel Radio Encryption Key", 4, /obj/item/device/encryptionkey/intel, null, VENDOR_ITEM_REGULAR),
		list("JTAC Radio Encryption Key", 4, /obj/item/device/encryptionkey/jtac, null, VENDOR_ITEM_REGULAR),
		list("Supply Radio Encryption Key", 4, /obj/item/device/encryptionkey/req, null, VENDOR_ITEM_REGULAR),

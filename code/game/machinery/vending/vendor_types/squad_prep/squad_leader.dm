...
GLOBAL_LIST_INIT(cm_vending_gear_leader, list(
		...
		list("M4 Pattern Armor", 15, /obj/item/clothing/suit/storage/marine/rto, null, VENDOR_ITEM_REGULAR),
		...
		list("Plastic explosive", 4, /obj/item/explosive/plastic, null, VENDOR_ITEM_RECOMMENDED),
		...
		list("M240 Incinerator Tank (Napthal)", 7, /obj/item/ammo_magazine/flamer_tank, null, VENDOR_ITEM_REGULAR),
		list("M240 Incinerator Tank (B-Gel)", 7, /obj/item/ammo_magazine/flamer_tank/gellied, null, VENDOR_ITEM_REGULAR),

		list("RESTRICTED FIREARMS", 0, null, null, null),
		list("M240 Incinerator Unit", 15, /obj/item/storage/box/guncase/flamer, null, VENDOR_ITEM_REGULAR),
		...
		list("Engineering Radio Encryption Key", 2, /obj/item/device/encryptionkey/engi, null, VENDOR_ITEM_REGULAR),
		list("Intel Radio Encryption Key", 2, /obj/item/device/encryptionkey/intel, null, VENDOR_ITEM_REGULAR),
		list("JTAC Radio Encryption Key", 2, /obj/item/device/encryptionkey/jtac, null, VENDOR_ITEM_REGULAR),
		list("Supply Radio Encryption Key", 2, /obj/item/device/encryptionkey/req, null, VENDOR_ITEM_REGULAR),
	))

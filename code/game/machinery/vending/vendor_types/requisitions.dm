...
/obj/structure/machinery/cm_vending/sorted/cargo_guns/populate_product_list(scale)
	listed_products = list(
		...
		*/ //RUCM CODE EDIT END
		//RUCM CODE START
		list("M37A2 Pump Shotgun", floor(scale * 30), /obj/item/weapon/gun/shotgun/pump/m37a, VENDOR_ITEM_POOR),
		list("MK221 Tactical Shotgun", floor(scale * 30), /obj/item/weapon/gun/shotgun/combat, VENDOR_ITEM_WELL_FUNDED),
		list("M37-17 Pump Shotgun", floor(scale * 30), /obj/item/weapon/gun/shotgun/pump/dual_tube/cmb/m3717, VENDOR_ITEM_WELL_FUNDED),
		//RUCM CODE END
...
/obj/structure/machinery/cm_vending/sorted/cargo_ammo/populate_product_list(scale)
	listed_products = list(
		...
		*/ //RUCM CODE EDIT END
		//RUCM CODE START
		list("Box Of Buckshot Shells", floor(scale * 56), /obj/item/ammo_magazine/shotgun/buckshot, VENDOR_ITEM_POOR),
		list("Box of Incendiary Buckshot Shells", floor(scale * 56), /obj/item/ammo_magazine/shotgun/incendiarybuck, VENDOR_ITEM_WELL_FUNDED),
		//RUCM CODE END
		...
		*/ //RUCM CODE EDIT END
		//RUCM CODE START
		list("M4RA Magazine (10x24mm)", floor(scale * 60), /obj/item/ammo_magazine/rifle/m4ra, VENDOR_ITEM_POOR),
		list("M41A MK2 Magazine (10x24mm)", floor(scale * 100), /obj/item/ammo_magazine/rifle, VENDOR_ITEM_POOR),
		list("M39 HV Magazine (10x20mm)", floor(scale * 100), /obj/item/ammo_magazine/smg/m39, VENDOR_ITEM_POOR),
		list("M4RA HEAP Magazine (10x24mm)", floor(scale * 60), /obj/item/ammo_magazine/rifle/m4ra/heap, VENDOR_ITEM_WELL_FUNDED),
		list("M4RA Incendiary (10x24mm)", floor(scale * 60), /obj/item/ammo_magazine/rifle/m4ra/incendiary, VENDOR_ITEM_WELL_FUNDED),
		list("M41A HEAP Magazine (10x24mm)", floor(scale * 100), /obj/item/ammo_magazine/rifle/heap, VENDOR_ITEM_WELL_FUNDED),
		list("M39 HEAP Magazine (10x20mm)", floor(scale * 100), /obj/item/ammo_magazine/smg/m39/heap, VENDOR_ITEM_WELL_FUNDED),
		list("M39 Incendiary Magazine (10x20mm)", floor(scale * 100), /obj/item/ammo_magazine/smg/m39/incendiary, VENDOR_ITEM_WELL_FUNDED),
		//RUCM CODE END
		...
		*/ //RUCM CODE EDIT END
		//RUCM CODE START
		list("M4RA AP Magazine (10x24mm)", floor(scale * 16), /obj/item/ammo_magazine/rifle/m4ra/ap, VENDOR_ITEM_POOR),
		list("M39 AP Magazine (10x20mm)", floor(scale * 12), /obj/item/ammo_magazine/smg/m39/ap, VENDOR_ITEM_POOR),
		list("M41A MK2 AP Magazine (10x24mm)", floor(scale * 10), /obj/item/ammo_magazine/rifle/ap, VENDOR_ITEM_POOR),
		//RUCM CODE END
		list("M4A3 AP Magazine (9mm)", floor(scale * 2), /obj/item/ammo_magazine/pistol/ap, VENDOR_ITEM_REGULAR),

		//RUCM CODE START
		list("M4RA Penetrating (10x24mm)", floor(scale * 16), /obj/item/ammo_magazine/rifle/m4ra/penetrating, VENDOR_ITEM_WELL_FUNDED),
		list("M39 Penetrating Magazine (10x20mm)", floor(scale * 12), /obj/item/ammo_magazine/smg/m39/penetrating, VENDOR_ITEM_WELL_FUNDED),
		list("M39 Light Explosive Magazine (10x20mm)", floor(scale * 12), /obj/item/ammo_magazine/smg/m39/le, VENDOR_ITEM_WELL_FUNDED),
		...
		*/ //RUCM CODE EDIT END
		//RUCM CODE START
		list("M41AE2 Box Magazine (10x24mm)", floor(scale * 3), /obj/item/ammo_magazine/rifle/lmg, VENDOR_ITEM_POOR),
		list("M41AE2 HEAP Rounds (10x24mm)", floor(scale * 3), /obj/item/ammo_magazine/rifle/lmg/heap, VENDOR_ITEM_WELL_FUNDED),
		list("M41A MK1 Magazine (10x24mm)", 4.5, /obj/item/ammo_magazine/rifle/m41aMK1, VENDOR_ITEM_POOR),
		list("M41A MK1 AP Magazine (10x24mm)", floor(scale * 2), /obj/item/ammo_magazine/rifle/m41aMK1/ap, VENDOR_ITEM_POOR),
		list("M41A MK1 HEAP Magazine (10x24mm)", floor(scale * 2), /obj/item/ammo_magazine/rifle/m41aMK1/heap, VENDOR_ITEM_WELL_FUNDED),
		list("M41A MK1 Incendiary Magazine (10x24mm)", floor(scale * 2), /obj/item/ammo_magazine/rifle/m41aMK1/incendiary, VENDOR_ITEM_WELL_FUNDED),
		list("M41A MK1 Toxic Magazine (10x24mm)", floor(scale * 2), /obj/item/ammo_magazine/rifle/m41aMK1/toxin, VENDOR_ITEM_WELL_FUNDED),
		list("M41A MK1 Penetrating Magazine (10x24mm)", floor(scale * 2), /obj/item/ammo_magazine/rifle/m41aMK1/penetrating, VENDOR_ITEM_WELL_FUNDED),
		//RUCM CODE END
		...
		*/ //RUCM CODE EDIT END
		//RUCM CODE START
		list("Magazine Box (AP M39 x 12)", 0, /obj/item/ammo_box/magazine/m39/ap, VENDOR_ITEM_REGULAR),
		list("Magazine Box (M39 x 12)", 0, /obj/item/ammo_box/magazine/m39, VENDOR_ITEM_POOR),
		list("Magazine Box (AP M39 x 12)", 0, /obj/item/ammo_box/magazine/m39/ap, VENDOR_ITEM_POOR),
		list("Magazine Box (HEAP M39 x 12)", 0, /obj/item/ammo_box/magazine/m39/heap, VENDOR_ITEM_WELL_FUNDED),
		list("Magazine Box (Incen M39 x 12)", 0, /obj/item/ammo_box/magazine/m39/incen, VENDOR_ITEM_WELL_FUNDED),
		list("Magazine Box (LE M39 x 12)", 0, /obj/item/ammo_box/magazine/m39/le, VENDOR_ITEM_WELL_FUNDED),
		//RUCM CODE END
		...
		*/ //RUCM CODE EDIT END
		//RUCM CODE START
		list("Magazine Box (M41A x 10)", 0, /obj/item/ammo_box/magazine, VENDOR_ITEM_POOR),
		list("Magazine Box (AP M41A x 10)", 0, /obj/item/ammo_box/magazine/ap, VENDOR_ITEM_POOR),
		list("Magazine Box (HEAP M41A x 10)", 0, /obj/item/ammo_box/magazine/heap, VENDOR_ITEM_WELL_FUNDED),
		list("Magazine Box (LE M41A x 10)", 0, /obj/item/ammo_box/magazine/ap, VENDOR_ITEM_WELL_FUNDED),
		list("Magazine Box (Incen M41A x 10)", 0, /obj/item/ammo_box/magazine/ap, VENDOR_ITEM_WELL_FUNDED),
		//RUCM CODE END
		...
		*/ //RUCM CODE EDIT END
		//RUCM CODE START
		list("Magazine Box (M4RA x 16)", 0, /obj/item/ammo_box/magazine/m4ra, VENDOR_ITEM_POOR),
		list("Magazine Box (AP M4RA x 16)", 0, /obj/item/ammo_box/magazine/m4ra/ap, VENDOR_ITEM_POOR),
		list("Magazine Box (HEAP M4RA x 16)", 0, /obj/item/ammo_box/magazine/m4ra/heap, VENDOR_ITEM_WELL_FUNDED),
		list("Magazine Box (Incen M4RA x 16)", 0, /obj/item/ammo_box/magazine/m4ra/incen, VENDOR_ITEM_WELL_FUNDED),
		//RUCM CODE END
		list("Magazine Box (Ext M4RA x 16)", 0, /obj/item/ammo_box/magazine/m4ra/ext, VENDOR_ITEM_REGULAR),
		list("Magazine Box (M41AE2 x 8)", 0, /obj/item/ammo_box/magazine/m41ae2, VENDOR_ITEM_POOR), //RUCM EDIT 	list("Magazine Box (M41AE2 x 8)", 0, /obj/item/ammo_box/magazine/m41ae2, VENDOR_ITEM_REGULAR),
		list("Magazine Box (M41AE2 Holo-Target x 8)", 0, /obj/item/ammo_box/magazine/m41ae2/holo, VENDOR_ITEM_REGULAR),
		//RUCM CODE START
		list("Magazine Box (M41AE2 HEAP x 8)", 0, /obj/item/ammo_box/magazine/m41ae2/heap, VENDOR_ITEM_WELL_FUNDED),
		//RUCM CODE END
		...
		//RUCM CODE START
		list("Shotgun Shell Box (Buckshot x 100)", 0, /obj/item/ammo_box/magazine/shotgun/buckshot, VENDOR_ITEM_POOR), //RUCM EDIT 		list("Shotgun Shell Box (Buckshot x 100)", 0, /obj/item/ammo_box/magazine/shotgun/buckshot, VENDOR_ITEM_REGULAR),
		list("Shotgun Shell Box (Incen Buckshot x 100)", 0, /obj/item/ammo_box/magazine/shotgun/incendiarybuck, VENDOR_ITEM_WELL_FUNDED),
		//RUCM CODE END

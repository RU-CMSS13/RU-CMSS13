/datum/tech/xeno/weed_damage_reduction
	...
	desc = "Actively causes weeds to reduce the damage taken by Xenomorphs by providing a layer of armour as long as a xenomorph is on weeds. WHEN ACTIVE - DRAINS 0.25 POINTS PER MINUTE"
	...
	var/point_drain_per_second = AMOUNT_PER_TIME(0.5, 1 MINUTES) // Drains 0.5 resource per 2 minute.

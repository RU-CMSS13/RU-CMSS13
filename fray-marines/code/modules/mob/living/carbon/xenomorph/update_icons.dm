...
/mob/living/carbon/xenomorph/proc/create_halo()
	...
	overlays_standing[X_HALO_LAYER] = image("icon" = 'fray-marines/code/modules/battlepass/rewards/sprites/halo.dmi', "icon_state" = get_halo_iconname())
...
/mob/living/carbon/xenomorph/proc/create_evil_halo()
	...
	overlays_standing[X_HALO_LAYER] = image("icon" = 'fray-marines/code/modules/battlepass/rewards/sprites/halo_red.dmi', "icon_state" = get_halo_iconname())
	apply_overlay(X_HALO_LAYER)
	has_halo = TRUE

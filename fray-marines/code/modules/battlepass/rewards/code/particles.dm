...
/particles/droplets
	icon = 'fray-marines/icons/effects/particles/generic.dmi'
...
/particles/slime
	icon = 'fray-marines/icons/effects/particles/goop.dmi'
...
/particles/pollen
	icon = 'fray-marines/icons/effects/particles/pollen.dmi'
	icon_state = "pollen"
	width = 100
	height = 100
	count = 1000
...
/particles/stink
	icon = 'fray-marines/icons/effects/particles/stink.dmi'
...
/particles/musical_notes
	icon = 'fray-marines/icons/effects/particles/notes/note.dmi'
	icon_state = list(
		"note_1" = 1,
		"note_2" = 1,
		"note_3" = 1,
...
/particles/musical_notes/holy
	icon = 'fray-marines/icons/effects/particles/notes/note_holy.dmi'
	icon_state = list(
		"holy_1" = 1,
		"holy_2" = 1,
		"holy_3" = 1,
...
/particles/musical_notes/nullwave
	icon = 'fray-marines/icons/effects/particles/notes/note_null.dmi'
	icon_state = list(
		"null_1" = 1,
		"null_2" = 1,
		"null_3" = 1,
...
/particles/musical_notes/harm
	icon = 'fray-marines/icons/effects/particles/notes/note_harm.dmi'
	icon_state = list(
		"harm_1" = 1,
		"harm_2" = 1,
		"harm_3" = 1,
...
/particles/musical_notes/sleepy
	icon = 'fray-marines/icons/effects/particles/notes/note_sleepy.dmi'
	icon_state = list(
		"sleepy_1" = 1,
		"sleepy_2" = 1,
		"sleepy_3" = 1,
...
/particles/musical_notes/light
	icon = 'fray-marines/icons/effects/particles/notes/note_light.dmi'
	icon_state = list(
		"power_1" = 1,
		"power_2" = 1,
		"power_3" = 1,

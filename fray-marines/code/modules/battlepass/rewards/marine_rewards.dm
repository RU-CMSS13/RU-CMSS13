...
/datum/battlepass_reward/marine/diamond_armor/on_claim(mob/target_mob)
	...
	marine_armor.icon = 'fray-marines/code/modules/battlepass/rewards/sprites/armorobj.dmi'
	...
	marine_armor.item_icons = list(
		WEAR_JACKET = 'fray-marines/code/modules/battlepass/rewards/sprites/armor.dmi'
	)
	...
	if(target_human.shoes)
		...
		target_human.shoes.icon = 'fray-marines/code/modules/battlepass/rewards/sprites/armorobj.dmi'
		target_human.shoes.icon_state = "diamond_boots"
		target_human.shoes.item_icons = list(
			WEAR_FEET = 'fray-marines/code/modules/battlepass/rewards/sprites/armor.dmi'
		)
	...
	if(istype(target_human.head, /obj/item/clothing/head/helmet/marine))
		...
		marine_helmet.icon = 'fray-marines/code/modules/battlepass/rewards/sprites/armorobj.dmi'
		...
		marine_helmet.item_icons = list(
			WEAR_HEAD = 'fray-marines/code/modules/battlepass/rewards/sprites/armor.dmi'
		)
...
/datum/battlepass_reward/marine/toy/runner_toy
	name = "Runner Toy"
	icon = 'fray-marines/code/modules/battlepass/rewards/sprites/toy.dmi'
...
/datum/battlepass_reward/marine/helmet_fire
	name = "Helmet Fire"
	icon = 'fray-marines/code/modules/battlepass/rewards/sprites/helmetfire.dmi'
...
/datum/battlepass_reward/marine/helmet_fire/on_claim(mob/target_mob)
	...
	helmet.helmet_fire_overlay_icon = mutable_appearance('fray-marines/code/modules/battlepass/rewards/sprites/helmetfire.dmi', helmet_fire_iconstate)
	helmet.helmet_fire_overlay_mob_icon = mutable_appearance('fray-marines/code/modules/battlepass/rewards/sprites/helmetfire.dmi', helmet_fire_iconstate)

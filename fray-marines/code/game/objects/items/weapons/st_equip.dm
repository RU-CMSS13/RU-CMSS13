...
/obj/item/weapon/shield/montage
	...
	icon = 'fray-marines/icons/mob/humans/st_equip.dmi'
	icon_state = "metal_st"
	item_icons = list(
		WEAR_L_HAND = 'fray-marines/icons/mob/humans/items_lefthand_1.dmi',
		WEAR_R_HAND = 'fray-marines/icons/mob/humans/items_righthand_1.dmi',
		WEAR_BACK = 'fray-marines/icons/mob/humans/back.dmi'
		)

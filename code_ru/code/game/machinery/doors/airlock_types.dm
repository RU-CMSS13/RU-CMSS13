...
/obj/structure/machinery/door/airlock/light_grey_lv/glass
	...
	icon = 'code_ru/icons/obj/structures/doors/light_grey_glass_door.dmi'
	opacity = FALSE
	glass = TRUE
	req_access = null
...
/obj/structure/machinery/door/airlock/light_grey_lv/solid
	name = "\improper Airlock"
	icon = 'code_ru/icons/obj/structures/doors/light_grey_solid_door.dmi'
	opacity = TRUE
	glass = FALSE
	req_access = null
...
/obj/structure/machinery/door/airlock/light_grey_lv/utility
	name = "\improper Airlock"
	icon = 'code_ru/icons/obj/structures/doors/light_grey_utility_door.dmi'
	opacity = TRUE
	glass = FALSE
	req_access = null

...
/obj/structure/machinery/door/airlock/multi_tile/lv_double/solid
	name = "\improper Airlock"
	icon = 'code_ru/icons/obj/structures/doors/light_grey_double_solid_door.dmi'
	opacity = TRUE
	glass = FALSE
	req_access = null
...
/obj/structure/machinery/door/airlock/multi_tile/lv_double/dark_grey/solid
	name = "\improper Airlock"
	icon = 'code_ru/icons/obj/structures/doors/2x1_dark_grey_airlock.dmi'
	opacity = TRUE
	glass = FALSE
	req_access = null
...
/obj/structure/machinery/door/airlock/multi_tile/lv_double/light_grey/solid
	name = "\improper Airlock"
	icon = 'code_ru/icons/obj/structures/doors/2x1_light_grey_airlock.dmi'
	opacity = TRUE
	glass = FALSE
	req_access = null

...
GLOBAL_LIST_INIT(cm_vending_synth_tools, list(
	...
	list("Compact Defibrillator", 10, /obj/item/device/defibrillator/compact, null, VENDOR_ITEM_REGULAR),
	...
	list("Tool Drop Pouch", 10, /obj/item/clothing/accessory/storage/tool_webbing/yellow_drop/equipped, null, VENDOR_ITEM_REGULAR),
	list("Logistics IMP Backpack", 10, /obj/item/storage/backpack/marine/satchel/big, null, VENDOR_ITEM_REGULAR),
	list("Expedition Chestrig", 10, /obj/item/storage/backpack/marine/satchel/intel/chestrig, null, VENDOR_ITEM_REGULAR),
	list("Expedition Satchel", 10, /obj/item/storage/backpack/marine/satchel/intel/expeditionsatchel, null, VENDOR_ITEM_REGULAR),

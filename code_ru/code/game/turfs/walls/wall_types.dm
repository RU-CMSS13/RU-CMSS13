...
/turf/closed/wall/lv_outpost/white
	name = "bare outpost walls"
	icon = 'code_ru/icons/turf/walls/white_lv_colony_walls.dmi'
	icon_state = "lvwall"
	desc = "A thick and chunky metal wall. The surface is barren and imposing."
...
/turf/closed/wall/wood/plain
	...
	icon = 'code_ru/icons/turf/walls/wood_plain.dmi'
	icon_state = "wood"
	walltype = WALL_WOOD
	baseturfs = /turf/open/floor/wood
...
/turf/closed/wall/wood/blue
	name = "blue wood wall"
	icon = 'code_ru/icons/turf/walls/wood_blue.dmi'
	icon_state = "wood"
	walltype = WALL_WOOD
	baseturfs = /turf/open/floor/wood
...
/turf/closed/wall/wood/green
	...
	icon = 'code_ru/icons/turf/walls/wood_green.dmi'
	icon_state = "wood"
	walltype = WALL_WOOD
	baseturfs = /turf/open/floor/wood
...
/turf/closed/wall/wood/purple
	...
	icon = 'code_ru/icons/turf/walls/wood_purple.dmi'
	icon_state = "wood"
	walltype = WALL_WOOD
	baseturfs = /turf/open/floor/wood
...
/turf/closed/wall/wood/teal
	name = "teal wood wall"
	icon = 'code_ru/icons/turf/walls/wood_teal.dmi'
	icon_state = "wood"
	walltype = WALL_WOOD
	baseturfs = /turf/open/floor/wood

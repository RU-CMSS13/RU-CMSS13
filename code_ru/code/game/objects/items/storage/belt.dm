...
/obj/item/storage/belt/gun/xm52/update_gun_icon(slot) //We do not want to use regular update_icon as it's called for every item inserted. Not worth the icon math.
	...
	if(current_gun)
		...
		*/
		...
		var/image/gun_underlay = image('code_ru/icons/obj/items/clothing/holstered_guns.dmi', current_gun.base_gun_icon)
		if(current_gun.type == /obj/item/weapon/gun/rifle/xm52)
			gun_underlay = image('code_ru/icons/obj/items/clothing/holstered_guns.dmi', current_gun.base_gun_icon)

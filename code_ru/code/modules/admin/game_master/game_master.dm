...
#define GAME_MASTER_AI_XENOS list(XENO_CASTE_DRONE, XENO_CASTE_RUNNER, RUNNER_ACIDER, XENO_CASTE_LURKER, XENO_CASTE_CRUSHER, XENO_CASTE_FACEHUGGER)
...
/datum/game_master/proc/InterceptClickOn(mob/user, params, atom/object)
	...
	switch(current_click_intercept_action)
		...
		if(OBJECTIVE_CLICK_INTERCEPT_ACTION)
			...
			SSminimaps.add_marker(object, z_level, MINIMAP_FLAG_ALL, blip = background)

...
/obj/item/clothing/suit/storage/marine/m40
	...
	unacidable = TRUE
	light_power = 4
	light_range = 5 //Like how in M3-EOD pattern heavy armor
...
/obj/item/clothing/suit/storage/marine/m40/proc/end_enrage(mob/living/carbon/human/H)
	...
	playsound(H, 'code_ru/sound/effects/hearth_attack.ogg', 25, TRUE)
...
/datum/action/item_action/specialist/enrage/New(mob/living/user, obj/item/holder)
	...
	button.name = name
	button.overlays.Cut()
	var/image/IMG = image('code_ru/icons/mob/hud/actions.dmi', button, "breacher")
	button.overlays += IMG

/datum/emote/living/carbon/human/spit
	...
	alt_message = "spits"
	sound = 'code_ru/sound/misc/spitemote.ogg'
	cooldown = 5 SECONDS
...
/datum/emote/living/carbon/human/laugh/get_sound(mob/living/user)
	...
	if(ishumansynth_strict(user))
		if(user.gender == MALE)
			return pick('code_ru/sound/voice/human_male_laugh_1.ogg', 'code_ru/sound/voice/human_male_laugh_2.ogg')
		else
			return pick('code_ru/sound/voice/human_female_laugh_1.ogg', 'code_ru/sound/voice/human_female_laugh_2.ogg')

...
/datum/battlepass_reward/marine/diamond_armor/on_claim(mob/target_mob)
	...
	marine_armor.icon = 'core_ru/code/modules/battlepass/rewards/sprites/armorobj.dmi'
	...
	marine_armor.item_icons = list(
		WEAR_JACKET = 'core_ru/code/modules/battlepass/rewards/sprites/armor.dmi'
	)
	...
	if(target_human.shoes)
		...
		target_human.shoes.icon = 'core_ru/code/modules/battlepass/rewards/sprites/armorobj.dmi'
		target_human.shoes.icon_state = "diamond_boots"
		target_human.shoes.item_icons = list(
			WEAR_FEET = 'core_ru/code/modules/battlepass/rewards/sprites/armor.dmi'
		)
	...
	if(istype(target_human.head, /obj/item/clothing/head/helmet/marine))
		...
		marine_helmet.icon = 'core_ru/code/modules/battlepass/rewards/sprites/armorobj.dmi'
		...
		marine_helmet.item_icons = list(
			WEAR_HEAD = 'core_ru/code/modules/battlepass/rewards/sprites/armor.dmi'
		)
...
/datum/battlepass_reward/marine/helmet_fire
	name = "Helmet Fire"
	icon = 'core_ru/code/modules/battlepass/rewards/sprites/helmetfire.dmi'
...
/datum/battlepass_reward/marine/helmet_fire/on_claim(mob/target_mob)
	...
	helmet.helmet_fire_overlay_icon = mutable_appearance('core_ru/code/modules/battlepass/rewards/sprites/helmetfire.dmi', helmet_fire_iconstate)
	helmet.helmet_fire_overlay_mob_icon = mutable_appearance('core_ru/code/modules/battlepass/rewards/sprites/helmetfire.dmi', helmet_fire_iconstate)
...
/datum/battlepass_reward/marine/m41a_reskin/on_claim(mob/target_mob)
	...
	gotten_rifle.icon = 'core_ru/icons/obj/items/weapons/guns/guns_by_faction/uscm.dmi'

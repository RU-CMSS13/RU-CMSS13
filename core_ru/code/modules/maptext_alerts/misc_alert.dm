/atom/movable/screen/text/screen_text/picture
	...
	layer = INTRO_LAYER
	plane = INTRO_PLANE
	icon = 'core_ru/icons/ui_icons/screen_alert_images.dmi'
...
/atom/movable/screen/text/screen_text/picture/potrait_custom_mugshot/Initialize(mapload, datum/hud/hud_owner, mob/living/mugshottee)
	...
	var/mutable_appearance/alphafilter = mutable_appearance('core_ru/icons/effects/alphacolors.dmi', "announcement")
	...
	var/image/static_overlay = image('core_ru/icons/UI_Icons/screen_alert_images.dmi', icon_state = image_to_play+"_static", pixel_y = image_to_play_offset_y, pixel_x = image_to_play_offset_x)

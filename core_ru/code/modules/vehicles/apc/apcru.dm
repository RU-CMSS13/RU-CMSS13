...
/obj/vehicle/multitile/apc/max/load_role_reserved_slots()
...
/obj/vehicle/multitile/apc/max/add_seated_verbs(mob/living/M, seat)
	if(!M.client)
		return
...
/obj/vehicle/multitile/apc/max/remove_seated_verbs(mob/living/M, seat)
	if(!M.client)
		return
...
/obj/vehicle/multitile/apc/max/initialize_cameras(change_tag = FALSE)
	if(!camera)
...
** PRESETS SPAWNERS
*/
/obj/effect/vehicle_spawner/apc/max
...
/obj/effect/vehicle_spawner/apc/max/Initialize()
	. = ..()
	spawn_vehicle()
	qdel(src)

//PRESET: no hardpoints
/obj/effect/vehicle_spawner/apc/max/spawn_vehicle()
	var/obj/vehicle/multitile/apc/max/APC = new (loc)
...
/obj/effect/vehicle_spawner/apc/max/plain/load_hardpoints(obj/vehicle/multitile/apc/max/V)
	V.add_hardpoint(new /obj/item/hardpoint/locomotion/apc_wheels)

//PRESET: default hardpoints, destroyed
/obj/effect/vehicle_spawner/apc/max/decrepit/spawn_vehicle()
	var/obj/vehicle/multitile/apc/max/APC = new (loc)
...
/obj/effect/vehicle_spawner/apc/max/decrepit/load_hardpoints(obj/vehicle/multitile/apc/max/V)
...
/obj/effect/vehicle_spawner/apc/max/fixed/load_hardpoints(obj/vehicle/multitile/apc/max/V)
	V.add_hardpoint(new /obj/item/hardpoint/primary/dualcannon)
	V.add_hardpoint(new /obj/item/hardpoint/secondary/frontalcannon)
	V.add_hardpoint(new /obj/item/hardpoint/support/flare_launcher)
	V.add_hardpoint(new /obj/item/hardpoint/locomotion/apc_wheels)
